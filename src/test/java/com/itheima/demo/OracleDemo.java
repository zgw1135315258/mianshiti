...
public class OracleDemo {
    ...
    public void javaCallOracle() throws Exception {
        ...
        //得到Connection连接
        Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@192.168.80.88:1521:orcl",
                "itheima", "itheima");
        //得到预编译的Statement对象
    ...
    public void javaCallProcedure() throws Exception {
        ...
        Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@192.168.80.88:1521:orcl",
                "itheima", "itheima");
        //得到预编译的Statement对象
        CallableStatement pstm = connection.prepareCall("{call f_job(?, ?)}");
        //给参数赋值
        pstm.setObject(1, 7788);
    ...
    public void javaCallFunction() throws Exception {
        ...
        Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@192.168.80.88:1521:orcl",
                "itheima", "itheima");
        //得到预编译的Statement对象
        CallableStatement pstm = connection.prepareCall("{?= call f_sal(?)}");
        //给参数赋值
